...
const IPLinkPageFour = () => {
    return (
      <div>
        <h1>ENLACE A PLC</h1>
        <p>
        Accede a la aplicación local de siemens a la siguiente dirección:{" "}
          <a href="http://192.168.1.7" target="_blank" rel="noopener noreferrer">
          <h2 className="link-zona">CONTROL A PLC ZONA (E)</h2>
          </a>
        </p>
        <div>
      <img 
